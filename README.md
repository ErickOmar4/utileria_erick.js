...
para ello debes ya sea descargar el archivo utileria.js y ponerlo en tu proyecto dentro del entre el area que abarcan el body del archivo html en donde lo quieras utilizar usando la etiqueta script y poniendo la ubicasión del archivo en tu proyecto


```
<script src="utileria.js"></script>
```
![implementacion en la linea 27](image.png)
